          ...
          child: Column(
            children: [
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: "Үйлчилгээний нэр"),
                validator: (val) => val == null || val.isEmpty ? 'Үйлчилгээ оруулна уу' : null,
              ),
              TextFormField(
                controller: issueController,
                decoration: const InputDecoration(labelText: "Гэмтлийн тайлбар"),
                validator: (val) => val == null || val.isEmpty ? 'Гэмтлийн мэдээлэл оруулна уу' : null,
              ),
              TextFormField(
